...
本项目是一个 DIY 光轴 Hitbox 控制器，使用红外发射和接收二极管作为按键开关，配合树莓派 Pico W 作为主控，运行 GP2040-CE 固件。相比传统机械轴，光轴具有更快的触发速度和更长的使用寿命。
...
- 焊接 0805 封装元件需要细尖烙铁头和放大镜/显微镜辅助
- 红外管有极性，注意区分发射管和接收管
- 建议先在废板上练习贴片焊接
- PCB 打样建议选择嘉立创等厂家，性价比高
